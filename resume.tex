...
\mobile{(+91) 98290 28732}
% \email{polli104@mail.chapman.edu}
\email{maheshwari.mrinal@gmail.com}
\github{maheshwarimrinal}
\linkedin{mrinalmaheshwari}
% \gitlab{gitlab-id}
% \stackoverflow{SO-id}{SO-name}
% \twitter{@MPollind}
% \skype{skype-id}
% \extrainfo{extra informations}
\homepage{www.mrinalmaheshwari.com}
